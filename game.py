...
class Game:
    def __init__(self):
        ...
        self.sfx = {
            ...
            'ambience': load_sound('ambience'),
        }
        
        self.sfx['jump'].set_volume(0.08)
        self.sfx['shoot'].set_volume(0.1)
        self.sfx['hit'].set_volume(0.2)
        self.sfx['dash'].set_volume(0.02)
        self.sfx['ambience'].set_volume(0.02)
    ...
    def run(self):
        ...
        self.sfx['ambience'].play(loops=-1)
        ...
        while True: 
            ...
            for projectile in self.projectiles.copy():
                ...
                if self.tilemap.solid_check(projectile[0]):
                    ...
                    for i in range(4):
                        self.sparks.append(Spark(projectile[0], random() - 0.5 + (math.pi if projectile[1] > 0 else 0), 2 + random()))
                    ...
                    if self.player.rect().collidepoint(projectile[0]):
                        ...
                        for i in range(30):
                            ...
                            speed = random() * 5
                            self.sparks.append(Spark(self.player.rect().center, angle, 2 + random()))
                            self.particles.append(Particle(self, 'particle', self.player.rect().center, velocity=[math.cos(angle + math.pi) * speed * 0.5, math.sin(angle + math.pi) * speed * 0.5], frame=randint(0, 7)))
            ...
            display_silhouette = display_mask.to_surface(setcolor=(0,0,0, 150), unsetcolor=(0,0,0,0))
